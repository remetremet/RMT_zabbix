...
IPV4OUT=$(( $IPV4OUT + $IPV4B ))
echo "${IPV4OUT}" > ${TEMPFILE}.ipv4_out
IPV4=$(( $IPV4 + $IPV4IN + $IPV4OUT ))
echo "${IPV4}" > ${TEMPFILE}.ipv4
...
IPV6OUT=$(( $IPV6OUT + $IPV6B ))
echo "${IPV6OUT}" > ${TEMPFILE}.ipv6_out
IPV6=$(( $IPV6 + $IPV6IN + $IPV6OUT ))
echo "${IPV6}" > ${TEMPFILE}.ipv6

chmod 666 ${TEMPFILE}.ip*
